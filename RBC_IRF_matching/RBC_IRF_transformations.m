function [modelIrf, error_indicator] = RBC_IRF_transformations(modelIrf, M_, options_mom_, ys_)
% [modelIrf, error_indicator] = RBC_IRF_transformations(modelIrf, M_, options_mom_, ys_)
% -------------------------------------------------------------------------
...
% the data has cumsum, so we need to use cumsum also on the model IRFs
